...
| 8099 | distribution APK | http.server | `mapnet-terrain-v1.1.0.apk` et `mapnet-navigation-v1.2.0.apk` |
...
- APK Navigation : `http://169.58.67.16:8099/mapnet-navigation-v1.2.0.apk`.
